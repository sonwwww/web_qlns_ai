    ...
    <div class="page_log" style="display: block;">
        <div class="contain_register_company">
            <div class="content_register_company">
                <form class="register_form_m" id="form-quen-m" method="POST">
                    <div class="one_page_qmk man-2" >
                        <div class="header_qmk">
                            <h1 class="qlc_tieude_moi">Xác thực tài khoản</h1>
                        </div>
                        <div class="ctn_form_mk form_group">
                            <div class="form-group-1">
                                <label class="form_label">Nhập mã xác thực đã gửi về mail</label>
                                <input type="text" name="ma_xt" id="ma_xt" class="form-control"
                                    placeholder="Nhập mã xác thực">
                            </div>
                        </div>
                        <div class="form-butt-one">
                            <input type="submit" class="tiep_tuc_one" value="Tiếp theo" id="xac-thuc">
                        </div>
                    </div>
