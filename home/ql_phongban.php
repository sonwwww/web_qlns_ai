...
if (isset($_GET['del_phong'])) {
    ...
    $sql_del_phong = mysqli_query($conn, "DELETE FROM ql_phongban WHERE id_phong = $ID_phong AND id_cty = $id_cty");
    $sql_upd_nv = mysqli_query($conn, "UPDATE user_nv SET id_phong = 0, chucvu = 'Nhân viên' WHERE id_phong = $ID_phong AND id_cty = $id_cty");
                            ...
                            <div class="ant-table-wrapper">
                                <table class="table_history">
                                    ...
                                    <tbody class="ant-table-tbody">
                                        <?php
                                        $sql = "SELECT * FROM ql_phongban WHERE id_cty = $id_cty";
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        $so_nv = mysqli_query($conn, "SELECT COUNT(id_nv) AS soluongnv FROM user_nv WHERE user_nv.id_phong = $row[id_phong] AND user_nv.id_cty = $id_cty");
